...
const useStyles = makeStyles((theme) => ({
  ...
  textField: {
    '& .MuiOutlinedInput-root': {
      ...
      '&:hover fieldset': {
        borderColor: 'white', // Set hover outline color to white
      },
    },
    '& label': {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Grid item xs>
            <Typography variant="h2" className={classes.text}>Jobs</Typography>
          </Grid>
          <Grid item xs>
            <TextField
              label="Search Jobs"
              ...
              InputProps={{
                endAdornment: (
                  <InputAdornment>
                    <IconButton onClick={() => getData() } style={{ color: 'white' }}>
                      <SearchIcon />
                    </IconButton>
                  </InputAdornment>
                ),
          ...
          <Grid item>
            <IconButton onClick={() => setFilterOpen(true)} style={{ color: 'white' }}>
        ...
        >
          {jobs.length > 0 ? (
            ...
            <Typography variant="h5" style={{ textAlign: "center" }} className={classes.text}>
              No jobs found
            </Typography>
          )}
        </Grid>
